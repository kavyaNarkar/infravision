...
import hero_img from './landing_imge.png'
...
export const teamData = [
  { name: 'Sharvil Dhumal', title: 'Team Member', image: 'https://ui-avatars.com/api/?name=Sharvil+Dhumal&background=5044E5&color=fff&size=128' },
  { name: 'Pranav Gounder', title: 'Team Member', image: 'https://ui-avatars.com/api/?name=Pranav+Gounder&background=5044E5&color=fff&size=128' },
  { name: 'Kavya Narkar', title: 'Team Member', image: 'https://ui-avatars.com/api/?name=Kavya+Narkar&background=5044E5&color=fff&size=128' },
  { name: 'Tanishk Surve', title: 'Team Member', image: 'https://ui-avatars.com/api/?name=Tanishk+Surve&background=5044E5&color=fff&size=128' },
]