...
const EmailVerified = () => {
    ...
    // Get content from state or use defaults (for email verification flow)
    const {
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {/* InfravisionAI Logo - Simplified for standalone page */}
                ...
                <button
                    ...
                    className="auth-button" // Using class from auth.css if available, else style matches
                    style={{
                        width: '100%',
                        padding: '0.875rem',
